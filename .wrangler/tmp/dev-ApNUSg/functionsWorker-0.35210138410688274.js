...
// .wrangler/tmp/pages-GbzcSv/functionsWorker-0.35210138410688274.mjs
...
__name2(flattenText, "flattenText");
...
__name2(buildRuleCatalog, "buildRuleCatalog");
...
__name2(callZhipuJson, "callZhipuJson");
...
__name2(normalizeL1Array, "normalizeL1Array");
...
__name2(normalizeL2Array, "normalizeL2Array");
...
__name2(normalizeL3, "normalizeL3");
...
__name2(buildPayloadFromThreeLevels, "buildPayloadFromThreeLevels");
...
__name(flattenText2, "flattenText2");
__name2(flattenText2, "flattenText");
function parseModelJson2(raw) {
  const text = String(raw || "").trim();
  const fence = text.match(/```(?:json)?\s*([\s\S]*?)```/i);
  return JSON.parse(fence ? fence[1].trim() : text);
}
__name(parseModelJson2, "parseModelJson2");
__name2(parseModelJson2, "parseModelJson");
...
__name2(callZhipu, "callZhipu");
function buildLanguageMirroringProtocol2() {
  return "\u8BED\u8A00\u955C\u50CF\u534F\u8BAE\uFF08Language Mirroring Protocol\uFF09\uFF1A\n\u4F60\u5FC5\u987B\u4E25\u683C\u4FDD\u6301\u8F93\u5165\u4E0E\u8F93\u51FA\u7684\u8BED\u8A00\u4E00\u81F4\u6027\u3002\u8BF7\u9996\u5148\u68C0\u6D4B\u7528\u6237\u63D0\u4F9B\u7684\u539F\u59CB\u8BED\u6599/\u8BC1\u636E/\u7F16\u7801\u662F\u4EC0\u4E48\u8BED\u8A00\u3002\n\u5982\u679C\u6750\u6599\u662F\u4E2D\u6587\uFF0C\u4F60\u7684\u5907\u5FD8\u5F55\u5FC5\u987B\u5168\u90E8\u4F7F\u7528\u4E2D\u6587\uFF1B\u5982\u679C\u6750\u6599\u662F\u82F1\u6587\uFF0C\u4F60\u5FC5\u987B\u5168\u90E8\u4F7F\u7528\u82F1\u6587\u3002\n\u7EDD\u5BF9\u7981\u6B62\u5728\u540C\u4E00\u4E2A\u8F93\u51FA\u4E2D\u4E2D\u82F1\u5939\u6742\uFF0C\u4E5F\u7EDD\u5BF9\u7981\u6B62\u64C5\u81EA\u5C06\u4E00\u79CD\u8BED\u8A00\u7FFB\u8BD1\u6210\u53E6\u4E00\u79CD\u8BED\u8A00\u3002\n";
}
__name(buildLanguageMirroringProtocol2, "buildLanguageMirroringProtocol2");
__name2(buildLanguageMirroringProtocol2, "buildLanguageMirroringProtocol");
...
__name(flattenText3, "flattenText3");
__name2(flattenText3, "flattenText");
function parseModelJson3(raw) {
  const text = String(raw || "").trim();
  const fence = text.match(/```(?:json)?\s*([\s\S]*?)```/i);
  return JSON.parse(fence ? fence[1].trim() : text);
}
__name(parseModelJson3, "parseModelJson3");
__name2(parseModelJson3, "parseModelJson");
...
__name(callZhipu2, "callZhipu2");
__name2(callZhipu2, "callZhipu");
function buildLanguageMirroringProtocol3() {
  return "\u8BED\u8A00\u955C\u50CF\u534F\u8BAE\uFF08Language Mirroring Protocol\uFF09\uFF1A\n\u4F60\u5FC5\u987B\u4E25\u683C\u4FDD\u6301\u8F93\u5165\u4E0E\u8F93\u51FA\u7684\u8BED\u8A00\u4E00\u81F4\u6027\u3002\u8BF7\u9996\u5148\u68C0\u6D4B\u7528\u6237\u63D0\u4F9B\u7684\u539F\u59CB\u8BED\u6599\u662F\u4EC0\u4E48\u8BED\u8A00\u3002\n\u5982\u679C\u539F\u59CB\u8BED\u6599\u662F\u4E2D\u6587\uFF0C\u4F60\u8F93\u51FA\u7684\u6240\u6709\u6982\u5FF5\u540D\u4E0E\u5173\u7CFB\u8BCD\u5FC5\u987B\u5168\u90E8\u4F7F\u7528\u4E2D\u6587\uFF1B\u5982\u679C\u539F\u59CB\u8BED\u6599\u662F\u82F1\u6587\uFF0C\u4F60\u5FC5\u987B\u5168\u90E8\u4F7F\u7528\u82F1\u6587\u3002\n\u7EDD\u5BF9\u7981\u6B62\u5728\u540C\u4E00\u4E2A\u8F93\u51FA\u4E2D\u4E2D\u82F1\u5939\u6742\uFF0C\u4E5F\u7EDD\u5BF9\u7981\u6B62\u64C5\u81EA\u5C06\u4E00\u79CD\u8BED\u8A00\u7FFB\u8BD1\u6210\u53E6\u4E00\u79CD\u8BED\u8A00\u3002\n";
}
__name(buildLanguageMirroringProtocol3, "buildLanguageMirroringProtocol3");
__name2(buildLanguageMirroringProtocol3, "buildLanguageMirroringProtocol");
...
// .wrangler/tmp/bundle-MjWgO3/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-MjWgO3/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.35210138410688274.js.map
